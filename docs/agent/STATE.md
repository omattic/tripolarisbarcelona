...
- Public logo, triangle artwork, SVG favicon, a 512x512 PNG favicon derived from the Tripolaris wordmark, and 1200x630 Open Graph preview image under `assets/`.
...
- Google Analytics 4 is installed on the homepage with measurement ID `G-NTH8RY80CL`.
